...
if (navigator.geolocation) {
  ...
  $.getJSON(api_call, function(data) {
    ...
    var image = "<img src = https://github.com/ckpantelides/weather/tree/master/images/" + data.currently.icon + ".svg>"
    $("#icon").html(image);
    ...
    for(var i = 1; i < 25; i++) {
      ...
      var icon_hourly = "<img src = https://github.com/ckpantelides/weather/tree/master/images/" + data.hourly.data[i].icon + ".svg>";
