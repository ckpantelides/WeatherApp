...
if (navigator.geolocation) {
  ...
  $.getJSON(api_call, function(data) {
    ...
    var image = "<img src = https://rawgit.com/ckpantelides/weather/master/images/" + data.currently.icon + ".svg?sanitize=true>"
    $("#icon").html(image);
    ...
    for(var i = 1; i < 25; i++) {
      ...
      var icon_hourly = "<img src = https://rawgit.com/ckpantelides/weather/master/images/" + data.hourly.data[i].icon + ".svg?sanitize=true>";
